    ...
    render() {
        ...
        return (
            <div className="notifications-container fixed w-[450px] max-[912px]:w-full flex flex-col top-0 right-0 p-2 max-[912px]:p-0">
                <div className={`notification-title text-right text-lg ${jumpyStyle} max-[912px]:p-1`}
                    onClick={() => { handleDisplayDrawer() }}>
                    Your notifications
                </div>
                {displayDrawer && (
                    <div className="root-notifications relative border-2 border-dashed border-[var(--main-color)
                                    max-[912px]:w-full
                                    max-[912px]:h-full
                                    max-[912px]:fixed
                                    max-[912px]:p-2
